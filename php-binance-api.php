...
class API
{
    ...
    {
        $qstring = 'v3/exchangeInfo';

        return $this->httpRequest($qstring, 'GET');
    }

    public function oco(string $symbol, $quantity, string $price, string $stopPrice, string $stopLimitPrice)
    {
        $opt = [
            'symbol' => $symbol,
            'side' => 'SELL',
